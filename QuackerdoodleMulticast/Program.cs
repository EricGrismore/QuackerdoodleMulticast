namespace assignment8ex1
{
    class Program
    {
        ...
        {
            mySong d1 = new mySong(HereComesTheSun.chorus);
            d1 += HereComesTheSun.chorus;
            d1 += HereComesTheSun.verse1;
            d1 += HereComesTheSun.chorus;
            d1 += HereComesTheSun.verse2;
            d1 += HereComesTheSun.chorus2;
            d1 += HereComesTheSun.verse3;
            d1 += HereComesTheSun.chorus;
            d1 += HereComesTheSun.chorus;
            d1 += HereComesTheSun.end;
            d1();
